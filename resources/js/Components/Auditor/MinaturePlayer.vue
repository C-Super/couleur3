    ...
    <div class="flex">
      ...
      <div class="text-container">
        ...
        <p class="text-xs font-light">
          Présenté par <br /><span class="text-primary">Patrick Dujany</span>
        </p>
      </div>
      <button class="shrink-0" @click="toggleVideo">
        <span v-if="!isPlaying" class="material-symbols-rounded p-1 text-4xl">
          play_arrow
        </span>
        <span v-else class="material-symbols-rounded p-1 text-4xl">pause</span>
      </button>
    </div>
  </template>
