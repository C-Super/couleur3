...
<template>
    <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-row w-full gap-10">
            ...
            <input-group id="input-2" class="flex-row items-center" label="2.">
                <slot name="input2"></slot>
            </input-group>
        </div>
        <div class="flex flex-row gap-10 w-full">
            <input-group id="input-3" class="flex-row items-center" label="3.">
                <slot name="input3"></slot>
            </input-group>

            <input-group id="input-4" class="flex-row items-center" label="4.">
